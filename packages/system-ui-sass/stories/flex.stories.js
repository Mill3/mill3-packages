...
const grows = Object.values(theme["flex-grow"]).map(
  ...
  <div class="bg-gray-100 m-0 mb-5 p-0 p-5">
    <ul class="d-flex list-none m-0 p-0 bg-gray-200">
      <li class="bg-color-primary color-white mr-3 p-2 flex-grow-0">.flex-grow-0</li>
      <li class="bg-color-primary color-white mr-3 p-2 flex-grow-${value}">.flex-grow-${value}</li>
      <li class="bg-color-primary color-white mr-3 p-2 flex-grow-2">.flex-grow-2</li>
      <li class="bg-color-primary color-white p-2 flex-grow-3">.flex-grow-3</li>
    </ul>
  </div>
  `
);
...
const shrinks = Object.values(theme["flex-grow"]).map(
  ...
  <div class="bg-gray-100 m-0 mb-5 p-0 p-5">
    <ul class="d-flex list-none m-0 p-0 bg-gray-200">
      <li class="w-30 bg-color-primary color-white mr-3 p-2 flex-shrink-0">.flex-shrink-0</li>
      <li class="w-30 bg-color-primary color-white mr-3 p-2 flex-shrink-${value}">.flex-shrink-${value}</li>
      <li class="w-30 bg-color-primary color-white mr-3 p-2 flex-shrink-2">.flex-shrink-2</li>
      <li class="w-30 bg-color-primary color-white p-2 flex-shrink-3">.flex-shrink-3</li>
    </ul>
  </div>
  `
);
