...
export const SimpleHorizontal = () => `
  <header class="d-grid grid-column-2 grid-column-md-3 w-100 p-10 bg-gray-300">
    <nav class="align-self-start d-none d-md-flex align-items-center h-100">
      <a href="#" class="mr-10">Item 1</a>
      <a href="#" class="mr-10">Item 2</a>
      <a href="#" class="mr-10">Item 3</a>
      <a href="#" class="mr-10">Item 4</a>
    </nav>
    ...
    <nav class="justify-self-end d-flex h-100 align-items-center">
      ...
      <button class="d-md-none ml-10 bg-transparent">🍔</button>
    </nav>
  </header>
`
