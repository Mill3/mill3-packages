...
export const AdvancedGridLayout = () => `
  ...
  <section class="pt-30 pb-30 pl-10 pl-lg-50 pr-10 pr-lg-50">
    <div class="MyComponent d-grid grid-column-2 grid-column-lg-3 grid-gap-10">
      <div class="MyComponent__cell bg-color-primary color-white p-20 d-grid grid-gap-10 grid-gap-md-0 grid-column-sm-2">
      ...
      <div class="MyComponent__cell bg-gray-100 p-20">Cell 4 <span class="d-none d-lg-inline">- now I'm spaning 2 grid column, from column 2</span></div>
    </div>
  </section>
`
...
export const CrossGridLayout = () => `
  ...
  <section class="p-md-30 p-lg-50 bg-gray-500">
    <div class="MyCrossGridLayout d-sm-grid grid-column-2 grid-column-lg-3 grid-gap-20">

      <header class="MyCrossGridLayout__cell d-block overflow-hidden position-relative vh-100 vh-md-50">
      ...
      <div class="MyCrossGridLayout__cell pl-20 pl-md-0 pr-20 pr-md-0 pt-30 pb-30 d-flex flex-column justify-content-between gray-700">
        <h3>Section title</h3>
