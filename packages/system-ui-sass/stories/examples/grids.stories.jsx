...
export const CrossGridLayout = () => `
  ...
  <section class="p-md-30 p-lg-50 bg-gray-500">
    <div class="d-sm-grid grid-column-2 grid-column-lg-3 grid-gap-20 overflow-hidden">
      ...
      <header class="col-start-1 col-end-limit d-block overflow-hidden position-relative vh-100 vh-md-50">
      ...
      <div class="col-start-1 col-end-limit col-end-span-lg-1 pl-20 pl-md-0 pr-20 pr-md-0 pt-30 pb-30 d-flex flex-column justify-content-between gray-700">
        <h3>Section title</h3>
